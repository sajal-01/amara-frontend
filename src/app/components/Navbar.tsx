...
import { SearchIcon, ShoppingIcon, UserIcon } from "@/app/icons";
...
function NavLink({ url, text }: NavLink) {
  ...
  return (
    <li className="flex">
      <Link
        href={url}
        className={`font-kumbh leading-5 text-xs font-light tracking-[2.4px] ${
  ...
  return (
    <div className="p-4 ">
      ...
      <div className="items-center flex-shrink-0 hidden lg:flex">
        ...
        <Logo src={logoUrl}>
          {logoText && <h2 className="text-2xl sr-only font-bold">{logoText}</h2>}
        </Logo>
        ...
        <div className="items-center flex-shrink-0 hidden lg:flex">
          <ul className="items-stretch hidden space-x-3 lg:flex">
            ...
            <UserIcon
            className={cn("w-6 h-6 group-hover:text-dark-brown", {
              "text-dark-brown": true,
            })}
          />
          <SearchBar>
            <button>
